  ...
  flipkart: {
    ...
    productMaterials: {
      containers: [
        ...
        "._3ExdjG",
        "li._21lJbe",
        "._1YokD2._2MImQY ._1mXcCf",
        "._1YokD2._2MImQY ._3ExdjG",
        "._1YokD2._2MImQY li._21lJbe",
      ],
      textMatch: siteConfig.amazon.productMaterials.textMatch,
    },
    price: [
      "._30jeq3", // Main price
      "._1_WHN1", // Alternative price
      "._2p6lqe", // Another price variant
      "._1YokD2._2MImQY ._30jeq3", // Nested price
    ],
    rating: [
      "._3LWZlK", // Main rating
      "._2d4LTz", // Alternative rating
      "._1YokD2._2MImQY ._3LWZlK", // Nested rating
    ],
    isProductValid: (node) => {
      return (
        node.querySelector("._4rR01T") ||
        node.querySelector(".s1Q9rs") ||
        node.querySelector("._30jeq3")
      );
    },
